...
class ConstraintLayoutJsonAdapter (
    ...
    private val childConstraintModelJsonAdapter : JsonAdapter<com.sgk.model.modal.ChildConstraintModel>
    ...
    override fun fromJson(reader: JsonReader): com.sgk.model.modal.ConstraintLayout {
        var children: MutableList<Element>? = null
        var childernConstrainsList : MutableList<com.sgk.model.modal.ChildConstraintModel>? = null
...
//                }
        ...
        return com.sgk.model.modal.ConstraintLayout(
...
//            id = id ?: System.currentTimeMillis().toString()
    ...
    override fun toJson(writer: JsonWriter, value: com.sgk.model.modal.ConstraintLayout?) {
        if (value == null) {
            writer.nullValue()
        } else {
            writer.beginObject()
