...
) : JsonAdapter<com.sgk.model.modal.Column>() {
...
//            KEY_ID
    ...
    override fun fromJson(reader: JsonReader): com.sgk.model.modal.Column {
...
//                }
        ...
        return com.sgk.model.modal.Column(
...
//            id = id ?: System.currentTimeMillis().toString()
    ...
    override fun toJson(writer: JsonWriter, value: com.sgk.model.modal.Column?) {
        if (value == null) {
            writer.nullValue()
        } else {
            writer.beginObject()
